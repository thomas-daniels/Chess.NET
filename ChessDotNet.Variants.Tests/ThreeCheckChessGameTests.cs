...
namespace ChessDotNet.Variants.Tests
{
    ...
    public class ThreeCheckChessGameTests
    {
        ...
        public static void TestRecordedChecks()
        {
            ...
            game.MakeMove(new Move("D1", "H5", Player.White), true);
            game.MakeMove(new Move("G7", "G6", Player.Black), true);
            game.MakeMove(new Move("H5", "E5", Player.White), true);
            Assert.AreEqual(1, game.ChecksByWhite);
            Assert.AreEqual(0, game.ChecksByBlack);
            game.MakeMove(new Move("D8", "E7", Player.Black), true);
            game.MakeMove(new Move("E5", "H8", Player.White), true);
            game.MakeMove(new Move("E7", "E4", Player.Black), true);
            Assert.AreEqual(1, game.ChecksByWhite);
            ...
            game.MakeMove(new Move("H8", "G8", Player.White), true);
            Assert.AreEqual(2, game.ChecksByWhite);
            game.MakeMove(new Move("E8", "E7", Player.Black), true);
            game.MakeMove(new Move("G8", "E8", Player.White), true);
